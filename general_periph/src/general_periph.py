...
class GeneralPeriphTop(LiteXModule):
    def __init__(self, platform,
        ...
        general_periph_files = [
            "gateware/LimeDFB/general/alive.vhd",
            "gateware/LimeDFB/general/FPGA_LED_cntrl.vhd",
            "gateware/LimeDFB/general/FPGA_LED2_ctrl.vhd",
            "gateware/LimeDFB/general/FX3_LED_ctrl.vhd",
            "gateware/LimeDFB/general/gpio_ctrl_top.vhd",
            "gateware/LimeDFB/general/gpio_ctrl.vhd",
            "gateware/LimeDFB/general/general_pkg.vhd",
            "gateware/LimeDFB/general_periph/src/general_periph_top.vhd",
            "gateware/LimeDFB/general_periph/src/general_periph_top_wrapper.vhd",
            "gateware/LimeDFB/general_periph/src/periphcfg_pkg.vhd",
        ]
